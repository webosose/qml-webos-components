...
# Input
HEADERS += performancelog.h \
           performancelogplugin.h \
           performancelogtracer.h \
           pmtrace_performancelog_provider.h

SOURCES += performancelog.cpp \
           performancelogplugin.cpp

OTHER_FILES += qmldir \
               performancelogplugindescription.json

other_files.files = qmldir \
                    performancelogplugindescription.json
other_files.path = $$WEBOS_INSTALL_QML/PerformanceLog

lttng {
    DEFINES += HAS_LTTNG
    SOURCES += pmtrace_performancelog_provider.c
...
target.path = $$WEBOS_INSTALL_QML/PerformanceLog

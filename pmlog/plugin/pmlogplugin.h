...
#ifndef PMLOGPLUGIN_H
#define PMLOGPLUGIN_H
...
class PmLogPlugin : public QQmlExtensionPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "com.palm.pmlog" FILE
    "pmlogplugindescription.json")
...
public:
     ...
     */
    static QObject *pmLogProvider(QQmlEngine *engine, QJSEngine *scriptEngine);
};
#endif // PMLOGPLUGIN_H
